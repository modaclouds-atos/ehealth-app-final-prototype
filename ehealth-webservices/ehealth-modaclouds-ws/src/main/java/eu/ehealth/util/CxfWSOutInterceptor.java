 ...
 *
 */
public class CxfWSOutInterceptor extends AbstractLoggingInterceptor
{
	 ...
	 * @param phase
	 */
	public CxfWSOutInterceptor(String phase)
	{
		super(phase);
	 ...
	 * @param lim
	 */
	public CxfWSOutInterceptor(int lim)
	{
		this();
		limit = lim;
	}
	 ...
	 * @param w
	 */
	public CxfWSOutInterceptor(PrintWriter w)
	{
		this();
		this.writer = w;
	}
	...
	{
		if (SystemDictionary.ACTIVATE_OUT_INTERCEPTOR_DB) {
			...
			Logger logger = getMessageLogger2(message);
	 ...
	 * @return
	 */
	private Logger getMessageLogger2(Message message)
	{
