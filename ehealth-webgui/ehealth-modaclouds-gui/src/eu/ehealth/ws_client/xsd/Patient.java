...
public class Patient
{
	...
	public Patient(java.lang.String ID,
			...
			eu.ehealth.ws_client.xsd.SocioDemographicData SD_Data,
			java.lang.String responsibleClinicianID,
			eu.ehealth.ws_client.xsd.SocialWorker socialWorker,
			eu.ehealth.ws_client.xsd.Consulter consulterInCharge,
			eu.ehealth.ws_client.xsd.GeneralPractitioner generalPractitioner,
			eu.ehealth.ws_client.xsd.Carer patientCarer)
	{
		this.id = ID;
